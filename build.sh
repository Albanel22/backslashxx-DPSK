...
# ==================== 5e. AJOUT DES DÉFINITIONS MANQUANTES DANS SUSFS.C ====================
...
SUSFS_EOF
    ...
    echo "✅ Définitions déjà présentes"
fi
