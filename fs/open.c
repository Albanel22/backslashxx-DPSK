...
retry:
    ...
    /*
     * --- SuSFS path check insertion (guarded) ---
     * Inserted immediately after lookup_flags declaration above.
     * This block only runs when CONFIG_KSU_SUSFS_SUS_PATH is enabled.
     */
...
/* The remainder of the file continues unchanged (upstream content) */
